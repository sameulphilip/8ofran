    ...
    return Semantics(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: Theme.of(
            context,
          ).textTheme.bodyLarge?.copyWith(color: AppColors.text500),
          labelStyle: Theme.of(
            context,
          ).textTheme.bodyMedium?.copyWith(color: AppColors.text500),
          filled: true,
          fillColor: AppColors.surface,
          prefixIcon: widget.icon == null
              ? null
              : Icon(widget.icon, color: AppColors.text500, size: 22),
